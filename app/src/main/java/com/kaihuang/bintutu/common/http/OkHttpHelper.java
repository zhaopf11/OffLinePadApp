...
//        }
    ...
    public OkHttpHelper() {
        ...
        mHttpClient = new OkHttpClient().newBuilder().connectTimeout(3 * 60 * 1000, TimeUnit.MILLISECONDS)
                .readTimeout(3 * 60 * 1000, TimeUnit.MILLISECONDS)
                .build();
        mGson = new Gson();
    ...
    public void post(String url, Map<String, Object> param, BaseCallback callback) {
        if(param != null && callback != null){
            Log.e("请求参数 ：",mGson.toJson(param).toString());
        ...
        mHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (response.isSuccessful()) {
                    ...
                    Log.e("resultStr返回数据 ：",resultStr.toString());
